...
class Talks {
    ...
    fun converteFalas(fala: String): String {
        ...
        when(fala)
        {
            ...
            "Cart" -> return "Esta é a tela de carrinho, nela você poderá escolher a opções,  produtos para listar o produtos e seus preços, total para falar o preço total, repetir para repetir a instrução, finalizar para finalizar a compra e voltar para voltar a tela anterior!"
            else -> return "A"
        }
